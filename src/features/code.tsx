...
export const Code = ({
  ...
  return (
    <code>
        ...
        <span className={colorConst}>const</span> <span className={colorIdentifier}>pronouns</span> = [<span className={colorString}>"he"</span>, <span className={colorString}>"him"</span>];<br />

        <span className={colorConst}>const</span> <span className={colorIdentifier}>degree</span> = <span className={colorString}>"Internet Systems Technologist (FEEVALE, 2011)"</span>;<br />
