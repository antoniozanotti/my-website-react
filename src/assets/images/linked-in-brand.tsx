...
export function LinkedInBrand() {
  return (
    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" className={styles.iconSize}>
      ...
      <g clipPath="url(#clip0_44_42)" filter="url(#filter0_i_44_42)">
      ...
      <defs>
        <filter id="filter0_i_44_42" x="0" y="0" width="48" height="52" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
